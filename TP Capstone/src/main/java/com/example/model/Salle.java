...
public class Salle {
    ...
    public void addReservation(Reservation r) { reservations.add(r); r.setSalle(this); }
    public Set<Equipement> getEquipements() { return equipements; }
    public void addEquipement(Equipement e) { equipements.add(e); e.getSalles().add(this); }
